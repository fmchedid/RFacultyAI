...
\caption{Example of what Explainpaper can be used for}\label{fig:unnamed-chunk-11}
\end{figure}
...
\caption{Example usage of GitHub Copilot}\label{fig:unnamed-chunk-12}
\end{figure}
...
\caption{Example of a programming task fed to Goblin Tool}\label{fig:unnamed-chunk-13}
\end{figure}
...
\caption{"Girl with a pearl earring and a snake" by Johannes Vermeer}\label{fig:unnamed-chunk-14}
\end{figure}
...
\caption{AIVI Dashboard}\label{fig:unnamed-chunk-16}
\end{figure}
