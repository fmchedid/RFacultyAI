...
\caption{Example of a question one could ask Google Bard}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{"Girl with a pearl earring and a snake" by Johannes Vermeer}\label{fig:unnamed-chunk-8}
\end{figure}
